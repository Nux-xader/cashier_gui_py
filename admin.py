...
class Admin_Page:
    def __init__(self, top=None):
        ...
        self.message.place(relx=0.050, rely=0.056, width=62, height=30)
        self.message.configure(font="-family {Poppins} -size 12")
        self.message.configure(foreground="#ffffff")
        self.message.configure(background="black")
        ...
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="#f93000")
        self.button1.configure(cursor="hand2")
        self.button1.configure(foreground="#ffffff")
        self.button1.configure(background="#f93000")
...
class Inventory:
    def __init__(self, top=None):
        ...
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="yellow")
        self.button1.configure(cursor="hand2")
        ...
        self.button2.configure(relief="flat")
        self.button2.configure(overrelief="flat")
        self.button2.configure(activebackground="#f93000")
        self.button2.configure(cursor="hand2")
        self.button2.configure(foreground="black")
        self.button2.configure(background="#f93000")
        self.button2.configure(font="-family {Poppins SemiBold} -size 12")
        self.button2.configure(borderwidth="0")
        ...
        self.button3.configure(relief="flat")
        self.button3.configure(overrelief="flat")
        self.button3.configure(activebackground="yellow")
        self.button3.configure(cursor="hand2")
        self.button3.configure(foreground="black")
        self.button3.configure(background="yellow")
        self.button3.configure(font="-family {Poppins SemiBold} -size 12")
        self.button3.configure(borderwidth="0")
        ...
        self.button4.configure(relief="flat")
        self.button4.configure(overrelief="flat")
        self.button4.configure(activebackground="yellow")
        self.button4.configure(cursor="hand2")
        self.button4.configure(foreground="black")
        self.button4.configure(background="yellow")
        self.button4.configure(font="-family {Poppins SemiBold} -size 12")
        self.button4.configure(borderwidth="0")
        ...
        self.button5.configure(relief="flat")
        self.button5.configure(overrelief="flat")
        self.button5.configure(activebackground="yellow")
        self.button5.configure(cursor="hand2")
        self.button5.configure(foreground="black")
        self.button5.configure(background="yellow")
        self.button5.configure(font="-family {Poppins SemiBold} -size 12")
        self.button5.configure(borderwidth="0")
        ...
        self.button6.configure(activebackground="yellow")
...
class add_employee:
    def __init__(self, top=None):
        ...
        self.button2.configure(relief="flat")
        self.button2.configure(overrelief="flat")
        self.button2.configure(activebackground="yellow")
        self.button2.configure(cursor="hand2")
        self.button2.configure(foreground="black")
...
class Update_Employee:
    def __init__(self, top=None):
        ...
        self.button1.place(relx=0.409, rely=0.837, width=96, height=34)
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="yellow")
        self.button1.configure(cursor="hand2")
