...
class bill_window:
    def __init__(self, top=None):
        ...
        self.button7.configure(activebackground="yellow")
        self.button7.configure(cursor="hand2")
        self.button7.configure(foreground="black")
        self.button7.configure(background="yellow")
        ...
        self.button8.configure(activebackground="yellow")
        self.button8.configure(cursor="hand2")
        self.button8.configure(foreground="black")
        self.button8.configure(background="yellow")
        ...
        self.button9.configure(activebackground="yellow")
